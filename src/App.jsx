    ...
    <div className="w-full max-w-md mx-auto p-4">
      ...
      >
        ...
        <motion.button
          ...
          className={`${
            !isExpanded ? "mt-9" : "mt-6"
          } mx-auto bg-white transition-colors hover:bg-gray-100 rounded-full shadow-md py-2 px-6 text-sm text-gray-600 flex items-center justify-center gap-2`}
